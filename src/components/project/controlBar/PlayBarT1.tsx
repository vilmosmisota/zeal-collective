...
export default function PlayBarT1({
  ...
  return (
    <div className="w-2/6  max-w-[200px] md:flex md:items-center md:justify-between relative">
      <div className="w-[90%] h-[7px] bg-peach400 rounded-xl absolute top-[50%] left-0 -translate-y-[50%]">
        <div
          style={{ width: `${barSize}% ` }}
          className={`h-[3px]  rounded-2xl absolute bg-zinc800 top-[50%] left-[1%] -translate-y-[50%]`}
        ></div>
      </div>
